import sys
sys.path.append('/Users/ethan/Documents/GitHub/nighthawk_society/museum/model.py')
from museum.model import User, Project
...
@app_project.route('/')
def project():
    return render_template("project.html", table=project_all())
